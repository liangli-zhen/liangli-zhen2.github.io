...
<p align="justify">My research is mainly on machine learning and optimisation. Related research topics include multimodal learning, adversarial robustness, domain generalisation, neural architecture search, foundation models, evolutionary multi-objective optimisation, and more.<a href="https://scholar.google.com/citations?user=dtv_LZkAAAAJ&hl=en"><img src="assets/img/gs.png" width="12px"></a> The driving force behind my dedication to advanced AI research is the dream of creating a smart AI friend for every human being. This vision not only fuels my passion for the field but also guides my approach to developing AI technologies that are safe, reliable, and beneficial to society.</p>
...
<ul align="justify">  
  ...
  <li>[Jan 2024] Our paper on MedNAS: Multi-scale Training-free Neural Architecture Search for Medical Image Analysis has been accepted by the IEEE Trans. on Evolutionary Computation.</li>
  ...
  <li>[Nov 2023] Our paper on Evolutionary Architecture Search for Generative Adversarial Networks Based on Weight Sharing has been accepted by the IEEE Trans. on Evolutionary Computation.</li>
